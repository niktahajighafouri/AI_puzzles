...
# retuns the smallest path after calculating the best path using A* algorithm
def main(puzzle):
...
def menu():
    ...
    user_input =  input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"8-Puzzle"+Fore.BLUE+"~"+Fore.WHITE+"@HOME"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"$ ")
    os.system("cls")
    if user_input == "2":
